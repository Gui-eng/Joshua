...
const headerTitles = ["id", "Date", "No. of Total Checks", "Total Amount", "Actions" ]
...
//   }, [])
  ...
  const tableData = sample.map((items) => {
    return {
        ...items,
        view : <Button onClick={() => {router.push('/sales/monthly/collection/breakdown')}}color='blue'>View</Button>
    }
})
      ...
      <div className='tw-w-full tw-h-full'>
        ...
        <div className='tw-w-full tw-flex tw-items-center tw-flex-col tw-pb-96'>
              ...
              <div className='tw-w-[95%] tw-p-4 tw-flex tw-justify-between tw-h-full tw-items-center' >
                <h1 className='tw-text-xl tw-ml-2 tw-font-bold'>Monthly Collection</h1>
              </div>
