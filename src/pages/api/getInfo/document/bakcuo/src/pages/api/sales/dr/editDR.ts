        ...
        case 'POST':
            {
                try {
                    ...
                    const deliveryRecipt = await prisma.deliveryRecipt.update({
                    ...
                    const updateEmpsOnSi = await prisma.deliveryRecipt.update({
                        where: { id: deliveryRecipt.id },
                        data: {
