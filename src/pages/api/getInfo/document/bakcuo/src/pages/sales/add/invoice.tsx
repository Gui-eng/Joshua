...
//setItemData({...itemData, discount : 0, quantity : 0, unit : ""})
  ...
  useEffect(() => {
    ...
    setItemData({...itemData, id : uuidv4(), ItemInfo : selectedItemData, itemInfoId : selectedItemData?.id, vatable : handleUndefined(selectedItemData?.VAT), discount : 0, quantity : 0, unit : ""})
