        ...
        <div className='tw-w-full tw-flex tw-h-[80vh]'>
              <div className='tw-w-[300px] tw-items-center tw-h-full tw-flex'>
                <div className=' tw-w-full tw-h-[98%] tw-border-x-2 tw-border-slate-300'>
                    <div className='tw-w-full tw-h-full  tw-flex tw-flex-col tw-items-center tw-py-20 '>
                      <ISideCard Icon={<User fill='teal' width={30}/>} name='Add User' link='/auth/register'/>
                      <ISideCard Icon={<Client fill='teal' width={30}/>} name='Add Client' link='/add/client'/>
                      <ISideCard Icon={<Item fill='teal' width={30}/>} name='Add Item' link='/add/item'/>
                    </div>
                </div>
              </div>
