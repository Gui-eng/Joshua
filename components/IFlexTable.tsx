...
export default function Itable({ data, headerTitles, color, setData} : Props) {
    ...
    <div>
      ...
      {datas.length > 0 ?  <Table.Footer>
          ...
          <Table.Row>
              ...
              <Table.HeaderCell>
                <Header as='h4'>{amount.totalAmount !== 0 ? amount.totalAmount.toFixed(2) : (nonVATAmount.vatableSales !== 0 ? nonVATAmount.vatableSales + nonVATAmount.vatExemptSales : '-' )}<Label color="blue" >₱</Label></Header>
              </Table.HeaderCell>
          </Table.Row>
